...
export const SearchBar = () => {
    ...
    return (
        <InputGroup className="search-bar">
            ...
            >
                <Dropdown.Item id="Title" onClick={() => getSearch("Title")}>Title</Dropdown.Item>
                <Dropdown.Item id="Author" onClick={() => getSearch("Author")}>Author</Dropdown.Item>
                <Dropdown.Item id="Genre" onClick={() => getSearch("Genre")}>Genre</Dropdown.Item>
                <Dropdown.Item id="Notes" onClick={() => getSearch("Notes")}>Notes</Dropdown.Item>
            </DropdownButton>
            <Form.Control 
