...
export const EditBook = () => {
    ...
    const editBook = async () => {
      ...
      console.log(`
        ...
        read: ${read ? read : book.read},
        date read: ${dateRead ? dateRead : book.dateRead},
        genre: ${genre ? genre : book.genre},
        notes: ${notes ? notes : book.notes},
        favorite: ${favorite ? favorite : book.favorite},
      `)
